        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://mausam.imd.gov.in https://reactjs.imd.gov.in https://internal.imd.gov.in https://satellite.imd.gov.in https://gibs.earthdata.nasa.gov https://*.tile.openstreetmap.org",
              "connect-src 'self' https://reactjs.imd.gov.in https://internal.imd.gov.in https://satellite.imd.gov.in https://api.open-meteo.com https://gibs.earthdata.nasa.gov https://*.tile.openstreetmap.org https://demotiles.maplibre.org https://generativelanguage.googleapis.com",
